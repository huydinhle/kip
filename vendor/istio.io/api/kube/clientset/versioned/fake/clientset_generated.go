...
import (
	clientset "istio.io/api/kube/clientset/versioned"
	authenticationv1alpha1 "istio.io/api/kube/clientset/versioned/typed/authentication/v1alpha1"
	fakeauthenticationv1alpha1 "istio.io/api/kube/clientset/versioned/typed/authentication/v1alpha1/fake"
	configv1alpha2 "istio.io/api/kube/clientset/versioned/typed/config/v1alpha2"
	fakeconfigv1alpha2 "istio.io/api/kube/clientset/versioned/typed/config/v1alpha2/fake"
	networkingv1alpha3 "istio.io/api/kube/clientset/versioned/typed/networking/v1alpha3"
	fakenetworkingv1alpha3 "istio.io/api/kube/clientset/versioned/typed/networking/v1alpha3/fake"
	rbacv1alpha1 "istio.io/api/kube/clientset/versioned/typed/rbac/v1alpha1"
	fakerbacv1alpha1 "istio.io/api/kube/clientset/versioned/typed/rbac/v1alpha1/fake"
